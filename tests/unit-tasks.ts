...
const tasksOn = buildImageTasks(scripts, cards, { cgPerChapter: 0, maxPerChapter: 0, figureEmotions: true });
...
const tasksOff = buildImageTasks(scripts, cards, { cgPerChapter: 0, maxPerChapter: 0, figureEmotions: false });
