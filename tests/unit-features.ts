...
function main(): void {
  ...
  assert(out0.includes("changeFigure:none -left -next;"), "章首应清左位立绘");
  assert(out0.includes("changeFigure:none -next;"), "章首应清中位立绘");
  assert(out0.includes("changeFigure:none -right -next;"), "章首应清右位立绘");
  ...
  assert(out1.includes("changeFigure:f_linche.png -left -next;"), "登场应有立绘");
  ...
  assert(outEmo.includes("changeFigure:f_linche_happy.png -left -next;"), "情绪对话应切换表情立绘");
