...
- NovelForge 본체는 [GNU GPL v3](./LICENSE) 라이선스 : 자유롭게 사용·수정·재배포할 수 있으며, 수정 버전은 동일 라이선스로 공개해야 합니다
- **내보낸 콘텐츠**: NovelForge로 생성·내보낸 게임·시나리오·소설·이미지 등 콘텐츠는 **귀하의 소유**이며, NovelForge 라이선스의 적용을 받지 않습니다
