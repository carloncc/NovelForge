...
- NovelForge 本体は[GNU GPL v3](./LICENSE) ライセンス：自由に使用・改変・再配布できますが、改変版は同じライセンスでオープンソース化する必要があります
- **エクスポートコンテンツ**：NovelForge で生成・エクスポートしたゲーム・シナリオ・小説・画像などのコンテンツは**あなたの所有物**であり、NovelForge のライセンスの対象外です
